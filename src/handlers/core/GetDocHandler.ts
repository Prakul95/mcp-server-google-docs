...
export class GetDocHandler extends BaseToolHandler {
    async runTool(args: GetDocInput , oauth2Client: OAuth2Client): Promise<CallToolResult> {
        const validArgs = args as GetDocInput;
    ...
    private async getDoc(client: OAuth2Client, args:GetDocInput ): Promise<docs_v1.Schema$Document> {
        try {
 ...
 */
private formatDocsList(document: docs_v1.Schema$Document, opts?: GetDocInput): string {
